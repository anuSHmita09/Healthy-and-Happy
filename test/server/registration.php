 ...
 //switch ($_POST['submit']) {
    //    case 'personalinfo':
          ...
          $goldums = $_POST['goldums'];
           $sql1 = "INSERT INTO registration (Id, uname, gender , dob, age, phone, uaddress, coach, trialDate, goldums) 
           VALUES ('$Id', '$uname', '$gender', '$dob', '$age', '$phone', '$uaddress', '$coach', '$trialDate', '$goldums')"; 
