...
LOCK TABLES `bodyeval` WRITE;
/*!40000 ALTER TABLE `bodyeval` DISABLE KEYS */;
INSERT INTO `bodyeval` VALUES ('1001','anushmita','','','','','','','','','','','0002-05-25');
/*!40000 ALTER TABLE `bodyeval` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-02 19:38:37
